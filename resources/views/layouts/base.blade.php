 ...
 <body>
    ...
    <div id="header">
        <div id="wrapper">
            <div id="menu">
                <a href="{{ url('/') }}">
                    <div class="menu_item" style="padding-bottom: 2px;">
                        <img src='/img/vipusknik_logo.png' alt = "Выпускник" style="
                                                                                        width: 180px;
                                                                                        margin-top: -12px;
                                                                                    ">
                    </div>
            ...
            <div id="register1">
                <h1 style="margin: 5px; margin-left: 18px;color: white;font-weight: 200;">Выпускник 2017</h1>
            </div>
        </div>
    </div>
    <div id="main_body">
        ...
        <div class="remodal" data-remodal-id="modal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc" >
            <div class="remodalBorder">
                ...
                <form id="feedback-form">
                    ...
                    <input type="text" class="putName form-field" name="sender_name" id="sender_name" placeholder="Ваше имя" required>
                    <input name="sender_mail_or_phone" id="sender_mail_or_phone" type="tel" class="putPhone form-field" placeholder="Email или номер телефона" required>
                    <textarea rows="10" cols="46" name="body" id="body" class="form-field" placeholder="Опишите цель запроса" required></textarea>
      ...
      <div id="footer">
        <div id="wrapper2">
            ...
            <div id ="snet" style="background-color: #194f67;">
                <!--p>Мы, в социальных сетях</p>
                <i class="vk icon"></i><i class="facebook f icon"></i-->
            </div>
...
<!-- Yandex.Metrika counter -->
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/44736745" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
