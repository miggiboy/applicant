...
@section('content')
      ...
      <div class="ui grid" style="margin-top: 15px;">
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 20) }}"><H3><i class="student icon"></i>Геология, горнодобывающая промышленность и добыча полезных ископаемых</H3></a>
          <p> Одна из самых высокооплачиваемых и востребованных специальностей в Кахахстане.</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 21) }}"><H3><i class="users icon"></i>Нефтегазовое и химическое производство</H3></a>
