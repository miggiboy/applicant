    ...
    <div id="subpage">
     ...
     <div class="ui grid" style="margin-top: 15px;">
        ...
        <div class="six wide column">
         <a href="{{ url('/educationandgum') }}"><H3><i class="student icon"></i>Образование и Гуманитарные науки</H3></a>
          <p>Если Вы хотите стать учителем и педагогом, или же Вас привлекают гуманитарные науки, то Вам сюда</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ url('/serviceandsociety')}}"><H3><i class="users icon"></i> Услуги и науки об Обществе</H3></a>
        ...
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 8) }}"><H3><i class="settings icon"></i>Технические науки и технологии</H3></a>
        ...
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 5) }}"><H3><i class="paint brush icon"></i> Искусство</H3></a>
        ...
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ url('/agriculture')}}"><H3><i class="paw icon"></i>Сельскохозяйственные науки и Ветеринария</H3></a>
          <p>Любите работать с землей или животными? Тогда Вам должны понравится специальности приведенные в этом разделе.</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 12) }}"><H3><i class="first aid icon"></i> Медицина и Фармацевтика</H3></a>
        ...
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 7) }}"><H3><i class="world icon"></i>Естественные науки</H3></a>
        ...
        <div class="two wide column"></div>
        <div class="six wide column">
        <a href="{{ route('specialitieslist', 11) }}"><H3><i class="spy icon"></i> Военное дело и Безопасность</H3></a>
          <p>
      ...
      <div class="ui tab segment t" data-tab="second">
        ...
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 14) }}"><H3><i class="student icon"></i>Образование</H3></a>
          <p>Если Вы хотите стать учителем и педагогом, или же Вас привлекают гуманитарные науки, то Вам сюда</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ url('/serviceandsocietyc')}}"><H3><i class="users icon"></i> Услуги и науки об Обществе</H3></a>
          <p>Хотите стать специалистом в сфере услуг? Или Вас привлекает юриспруденция, бизнес и менеджмент?
          Если ответ да, то этот раздел специально для Вас.
          </p>
        </div>
        ...
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ url('/technique')}}"><H3><i class="settings icon"></i>Технические науки и технологии</H3></a>
          <p>Для тех, кто мечтает стать инжинером, программистом или хочет найти себя в энергетике, строительстве, машиностроении и во многих других технических отраслях. </p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
         <a href="{{ route('specialitieslist', 17) }}"><H3><i class="paint brush icon"></i> Искусство</H3></a>
          <p>Данный раздел содержит специальности для людей, желающих реализовать свой творческий потенциал.
          </p>
        </div>
        <div class="one wide column"></div>
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 28) }}"><H3><i class="paw icon"></i>Сельскохозяйственные науки, Ветеринария и Экология</H3></a>
          <p>Любите работать с землей или животными? Тогда Вам должны понравится специальности приведенные в этом разделе.</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 16) }}"><H3><i class="first aid icon"></i> Медецина и Фармацевтика</H3></a>
        ...
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ url('/natural')}}"><H3><i class="world icon"></i>Естественные науки</H3></a>
          <p>Вам нравится физика или химия, хотите изучать науки связанные с природой? Тогда пополните число специалистов по естественным наукам </p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 19) }}"><H3><i class="certificate icon"></i> Метрология, стандартизация и сертефикация</H3></a>
          <p>
