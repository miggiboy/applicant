...
@section('content')
      ...
      <div class="ui grid" style="margin-top: 15px;">
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 22) }}"><H3><i class="student icon"></i>Энергетика</H3></a>
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 23) }}"><H3><i class="users icon"></i> Металлургия и машностроение</H3></a>
      ...
      <div class="ui grid" style="margin-top: 15px;">
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 24) }}"><H3><i class="student icon"></i>Транспорт</H3></a>
          <p>Хотите научиться делать машины и самолеты? Тогда смело заходите в данный раздел</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 25) }}"><H3><i class="users icon"></i> Производство, монтаж, эксплуатация и ремонт транспорта</H3></a>
       ...
       <div class="ui grid" style="margin-top: 15px;">
        <div class="one wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 26) }}"><H3><i class="student icon"></i>Связь, Телекоммуникации и Информационные Технологии</H3></a>
        ...
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 27) }}"><H3><i class="users icon"></i> Строительство и коммунальное хозяйство</H3></a>
