...
@section('content')
      ...
      <div class="ui grid" style="margin-top: 15px;">
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 18) }}"><H3><i class="student icon"></i>Сервис, экономика, управление</H3></a>
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 15) }}"><H3><i class="users icon"></i>Право</H3></a>
