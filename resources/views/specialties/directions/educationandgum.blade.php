...
@section('content')
      ...
      <div class="ui grid" style="margin-top: 15px;">
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 2) }}"><H3><i class="student icon"></i>Образование</H3></a>
          <p>Для тех, кто хочет стать педагогом и не только.</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 3) }}"><H3><i class="users icon"></i> Гуманитарные науки</H3></a>
