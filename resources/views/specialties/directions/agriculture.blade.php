...
@section('content')
      ...
      <div class="ui grid" style="margin-top: 15px;">
        ...
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 9) }}"><H3><i class="student icon"></i>Сельское хозяйство</H3></a>
          <p>Сельское хозяйство занимает важное место в Казахстане, однако ощущется нехватка дипломированных специалистов.</p>
        </div>
        <div class="two wide column"></div>
        <div class="six wide column">
          <a href="{{ route('specialitieslist', 13) }}"><H3><i class="users icon"></i> Ветеринария</H3></a>
